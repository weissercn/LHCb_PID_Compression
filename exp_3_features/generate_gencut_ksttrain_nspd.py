"""
This file  generate_gencut_ksttrain_nspd.py is like generate_gencut_ksttrain.py but with the nspd variable added
...
# 1. GAN
MODEL_NAME = "GAN_Kramer_pid{}_ksttrain_nspd".format(inv_pids[args.particle_type])
