"""
This file  generate_gencut_ksttrain_nspdsigpnn.py is like generate_gencut_ksttrain_nspd.py but transforming the pnn variable with an inverse sigmoid function to make training faster
...
# 1. GAN
MODEL_NAME = "GAN_Kramer_pid{}_ksttrain_nspdsigpnn".format(inv_pids[args.particle_type])
