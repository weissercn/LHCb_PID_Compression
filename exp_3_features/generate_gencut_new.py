"""
This file is like generate_gencut_new.py like generate_gencut.py but running on a model trained on half the data and generates new MC from a trained GAN. However, it allows us to regenerate an event if it doesn't pass a cut.    
Run like:
...
# 1. GAN
MODEL_NAME = "GAN_Kramer_pid{}_new".format(inv_pids[args.particle_type])
