"""
This file is like generate.py and generates new MC from a trained GAN. However, it allows us to regenerate an event if it doen't pass a cut
"""
...
parser.add_argument('cut_type', choices=['none', 'pidmu'],
