"""
This file  generate_gencut_ksttrain_nspdsigpnnrestr.py is like generate_gencut_ksttrain_nspdsigpnn.py but with nspd values required to be above 0 and below 450
...
# 1. GAN
MODEL_NAME = "GAN_Kramer_pid{}_ksttrain_nspdsigpnnrestr".format(inv_pids[args.particle_type])
